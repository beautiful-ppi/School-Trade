...
import com.jinyuan.mapper.TUserMapper;
import com.jinyuan.service.TUserService;
...
public class TUserServiceImpl implements TUserService {
    ...
    //决定分页查询还是条件查询
    @Override
    public List<TUser> pageOrCondition(String queryCondition) {
    ...
    public List<TUser> selectUnhonestUserPageOrCondition(String queryCondition) {
