...
import com.jinyuan.service.impl.TRequestMatchServiceImpl;
...
public class TRequestMatchController {
    ...
    public Result selectAllRequestMatchInfo() {
        List<Map<String,Object>> mapList=trequestMatchServiceImpl.selectAllRequestMatchInfos();
