...
import com.jinyuan.service.impl.TUserServiceImpl;
...
public class TUserController {
    ...
    public Result selectUnhonestTradeDetail(@PathVariable("_id")int _id) {
    ...
    public Result selectUnhonestUser(@RequestParam(required=false,value="queryCondition")String queryCondition) {



        List<TUser> tUserList=tuserServiceImpl.selectUnhonestUserPageOrCondition(queryCondition);
    ...
    public Result selectUserByPage(@RequestParam(required=false,value="queryCondition")String queryCondition) {

        List<TUser> list= tuserServiceImpl.pageOrCondition(queryCondition);
    ...
    //注册
    @RequestMapping(value="insertUserWithPhoto",method= RequestMethod.POST)
